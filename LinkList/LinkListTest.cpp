...
/*
资料参考：http://blog.csdn.net/wujiangming7/article/details/50886625
线性表是最基本、最简单、也是最常用的一种数据结构。
线性表有两种存储方式，一种是顺序存储结构，一种是
链式存储结构。
	顺序存储结构就是两个相邻的元素在内存中也是相邻的。有点事查询的时间复杂度
	为o(1)，通过首地址和偏移量就可以直接访问到某元素。缺点是插入和删除的时间
	复杂度能达到o(n)
*/
